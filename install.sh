#!/usr/bin/env sh
# Universal installer for pwnreview. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/pwnreview.git"
echo "Installing pwnreview ..."
